...
{
    public class GlobalAdminTileTests : WebDriverTestBase
    {
       ...
       [Row(2, 1)]
       [Row(1, 2)]
        public void Verify_Key_Dates_Tile(int x, int y)
        {
            String tile_under_test = "Key Dates";
            SSOLoginPage.OpenSSOLoginPage(Config.Settings.runTimeSettings.EnvironmentUrl)
                     .LoginAs(username, password)
                      .RemoveTileIfPresent(tile_under_test)
                      .EnterSettings()
        ...
        [Row(2, 1)]
        [Row(2, 2)]
        public void Verify_Jobs_Tile(int x, int y)
        {
        ...
        [Test]
          [Row(2, 1)]
          [Row(2, 2)]
        public void Verify_Sales_Essential_Headlines_Tile(int x, int y)
        {
            String tile_under_test = "Sales Essentials Headlines";
            SSOLoginPage.OpenSSOLoginPage(Config.Settings.runTimeSettings.EnvironmentUrl)
                     .LoginAs(username, password)
        ...
        [Row(2, 1)]
        [Row(1, 2)]
        public void Verify_Innovation_At_HP_Labs_Blog_Tile(int x, int y)
        {
            String tile_under_test = "Innovation @HP Labs Blog";
            SSOLoginPage.OpenSSOLoginPage(Config.Settings.runTimeSettings.EnvironmentUrl)
                     .LoginAs(username, password)
                      .RemoveTileIfPresent(tile_under_test)
                      .EnterSettings()
                      ...
                      .ClickDone()
                      .VerifyTileSize(tile_under_test, x, y)
                      .VerifyTile(typeof(InnovationAtHPLabsBlog));
        }
